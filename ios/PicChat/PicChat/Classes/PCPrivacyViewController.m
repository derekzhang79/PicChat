...
@interface PCPrivacyViewController () <UIWebViewDelegate>
@property (nonatomic, strong) MBProgressHUD *progressHUD;
@end

@implementation PCPrivacyViewController
...
- (void)loadView {
	...
	PCHeaderView *headerView = [[PCHeaderView alloc] initWithTitle:@"Privacy"];
	...
	[webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/privacy.htm", [PCAppDelegate apiServerPath]]]]];
